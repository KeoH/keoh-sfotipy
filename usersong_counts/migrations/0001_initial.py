...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CountSongUser'
        db.create_table(u'usersong_counts_countsonguser', (
        ...
        db.send_create_signal(u'usersong_counts', ['CountSongUser'])


    def backwards(self, orm):
        # Deleting model 'CountSongUser'
        db.delete_table(u'usersong_counts_countsonguser')
    ...
    models = {
        ...
        u'usersong_counts.countsonguser': {
            'Meta': {'object_name': 'CountSongUser'},
